...
export ZSH=/Users/xcoan/.oh-my-zsh
...
export BUNDLE_EDITOR=/usr/local/bin/vim
...
alias add="git add"
alias forcepush="git push origin HEAD --force"
...
alias tf="terraform" # shorthand - use tf init, tf plan, etc
